#Will rework this later, rn sufficient enough for creating files 
# to add effect make a new effect subclass and put the same stuff as the other ones (toggles) and add the hotkey to the list and add another if/else in the on_hotkey_press
